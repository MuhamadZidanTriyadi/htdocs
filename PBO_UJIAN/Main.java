...
public class Main {
    ...
    private static void updateData() throws IOException{
        System.out.println("mengaupdate data gais");
        ...
        while (data != null){
            ...
            if (updateNum == entryCounts){
                ...
                boolean isUpdate = getYesorNo("apakah anda yain ingin mengupdate data tersebut");
        ...
        bufferedOutput.flush();fileInput.close();
        fileOutput.close();
        bufferedInput.close();
    ...
    private static void deleteData() throws  IOException{
        ...
        while (data != null){
            ...
            if (deleteNum == entryCounts){
                ...
                isDelete = getYesorNo("Apakah kamu yakin akan menghapus?");
                isFound = true;
            }
